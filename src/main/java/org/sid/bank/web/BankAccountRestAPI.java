...
import org.sid.bank.dtos.AccountHistoryDTO;
import org.sid.bank.dtos.AccountOperationDTO;
...
import org.sid.bank.services.BankService;
...
public class BankAccountRestAPI {
    ...
    public List<AccountOperationDTO>getHistory(@PathVariable String accountId){return bankAccountService.accountHistory(accountId);  }
